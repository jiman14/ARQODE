...
namespace ARQODE_Core
{
    public class CCron
    {
        ...
        private void Tcron_Tick(object sender, EventArgs e)
        {
            ...
            if (runProgram != null)
            {
                CEventDesc desc = new CEventDesc(dGLOBALS.CRON_CALL_TEXT, dGLOBALS.CRON_CALL_TEXT, 
                    dGLOBALS.CRON_CALL_TEXT, dGLOBALS.CRON_CALL_TEXT, tcron.Tag.ToString());
        ...
        {
            foreach (String program_name in program_list.Keys)
            {
