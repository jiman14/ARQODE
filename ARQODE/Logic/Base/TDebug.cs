...
namespace TLogic
{
    public class TDebug
    {
        ...
        internal JToken processError
        {
            set
            {
                debugInfo.set(dDEBUG.STATUS, debugStatus.PROCESS_ERROR.ToString());
                debugInfo.set(dDEBUG.DESCRIPTION, value);
            }
        }
        internal JToken unhandledError
        {
            set
            {
                debugInfo.set(dDEBUG.STATUS, debugStatus.UNHANDLED_ERROR.ToString());
                debugInfo.set(dDEBUG.DESCRIPTION, value);
            }
        }
        /// <summary>
